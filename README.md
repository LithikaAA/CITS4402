...
5. **Identity Clustering:** Bulk processes images, extracts facial features, and utilizes density-based clustering (DBSCAN) to find the number of unique identities without predefined cluster counts.

## Setup and Installation

**1. Clone the repository:**
```bash
git clone https://github.com/LithikaAA/CITS4402.git
cd CITS4402
```
...
## Requirements
See `requirements.txt`. Key dependencies: OpenCV, MediaPipe, scikit-learn, Pillow, NumPy.